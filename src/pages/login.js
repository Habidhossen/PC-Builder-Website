...
const LoginPage = () => {
  return (
    <section className="pt-32 h-screen w-full flex justify-center">
      <div className="bg-white rounded-xl px-6 w-1/3 h-96 flex flex-col items-center justify-center">
