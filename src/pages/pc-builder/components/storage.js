...
const StorageDeviceComp = ({ productData }) => {
  return (
    <section className="container mx-auto px-8 md:px-20 lg:px-60 py-12">
      <div className="text-center mb-8">
        <h1 className="text-xl font-bold">Storage Device</h1>
      ...
      <nav className="text-sm mb-8">
        <ol className="list-reset flex text-grey">
          ...
          <li className="text-gray-600 font-semibold">Storage Device</li>
        </ol>
      </nav>
...
export default StorageDeviceComp;
